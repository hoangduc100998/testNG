package ductester.Utilities.Helpers;

import java.io.FileInputStream;
import java.io.FileOutputStream;
import java.util.Properties;
public class thiPropertiesFile {
    ...
    private static String propertiesFilePathRoot = "src/main/java/ductester/TestData/configs.properties";
