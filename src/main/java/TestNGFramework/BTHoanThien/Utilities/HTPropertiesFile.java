package TestNGFramework.BTHoanThien.Utilities;
import java.io.FileInputStream;
import java.io.FileOutputStream;
import java.util.Properties;

public class HTPropertiesFile {
    ...
    private static String propertiesFilePathRoot
            = "src/main/java/TestNGFramework/BTHoanThien/Data/HTconfigs.properties";
