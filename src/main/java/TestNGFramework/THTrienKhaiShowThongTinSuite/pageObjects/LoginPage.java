package TestNGFramework.THTrienKhaiShowThongTinSuite.pageObjects;
...
public class LoginPage {
    ...
    public static void Login(WebDriver driver , String username, String password) {
        TestNGFramework.C2THTaoChromeDrivertuBeforeSuite.pageObjects.LoginPage.txtbx_UserName(driver).sendKeys(username);
        TestNGFramework.C2THTaoChromeDrivertuBeforeSuite.pageObjects.LoginPage.txtbx_Password(driver).sendKeys(password);
        TestNGFramework.C2THTaoChromeDrivertuBeforeSuite.pageObjects.LoginPage.btn_Login(driver).click();
    }
}
